...
st.markdown("How to Cite this Work:- X. Wang, Y. Geng, Y. Oliinyk, Z. Zhang, A. Kunwar, Multiscale Computation and Experimental Insights into Thermal History and Composition based Study of Strength-Ductility Synergy in Zr-Enhanced AlSiMg Alloys , 2025")
